...
RUN git clone --bare https://github.com/lausser/check_mssql_health.git ;\
	...
	git -C check_ssl_cert.git archive --prefix=check_ssl_cert/ 1d8d5e2c09259bec138b9fc42ed5cb4f24f83698 |tar -x ;\
	rm -rf *.git
